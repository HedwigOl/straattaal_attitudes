...
if __name__ == "__main__":
    if len(sys.argv) != 7:
        print("Usage: python create_word_test_prompts.py <stimuli_file> <prompt_file> <stimuli_column> <meaning_columns> <prompt_column> <output name>")
        sys.exit(1)
    ...
    create_prompt_csv(input_file_stimuli, input_file_prompts, stimuli_column, meaning_columns, prompt_column, output_file)
