...
# T test for class and ethnicity
t.test(data_response$class, data_response$ethnicity, paired = TRUE)


### Linear models not reported in final version thesis
